 ...
 * «цвет / фон»: текст — 4.5:1 (1.4.3), графика вроде столбцов и маскота —
...
// Графика: порог 3:1. Столбцы BarChart стоят и на фоне страницы, и в Card.
const graphicPairs = [
  ['--chart-neutral', '--bg', 'столбец BarChart / фон страницы', AA_GRAPHIC],
  ['--chart-neutral', '--bg-elev', 'столбец BarChart / карточка', AA_GRAPHIC],
